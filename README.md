...
* **Falta de Dependência Principal (`ModuleNotFoundError: No module named 'skopt'`):** Correção da quebra do pipeline em produção gerada pela falta da declaração explícita da biblioteca `scikit-optimize` nel arquivo de requerimentos do projeto.
